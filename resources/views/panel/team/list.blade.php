                    ...
                    <table datatable class="table table-bordered table-hover table-striped w-100">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center wd-80">Ünvan</th>
                                <th class="text-center wd-100">Eklenme</th>
        ...
        BaseCRUD.ajaxtable({
            ...
            columns: [
                { data: 'id', name: 'id', className: 'text-center' },
                {
                    ...
                    {
                        var html = '';
                        html += '<img src="' + row.image + '" class="img-fluid rounded-circle" style="width: 50px; height: 50px;">';
