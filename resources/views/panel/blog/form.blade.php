                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="file" class="form-control" name="image" value="{{ old('image') ? old('image') : $item->image }}" required>
                                </div>
                                @error('image')
                                    <span class="badge badge-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="author" value="{{ old('author') ? old('author') : $item->author }}" required>
                                </div>
                                @error('author')
                                    <span class="badge badge-danger">{{ $message }}</span>
                                @enderror
