                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="file" class="form-control" name="icon" value="{{ old('icon') ? old('icon') : $item->icon }}" required>
                                </div>
                                @error('icon')
                                    <span class="badge badge-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="content" value="{{ old('content') ? old('content') : $item->content }}" required>
                                </div>
                                @error('content')
                                    <span class="badge badge-danger">{{ $message }}</span>
                                @enderror
